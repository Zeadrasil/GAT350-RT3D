...
namespace nc
{
    bool World0575::Initialize()
    {
        ...
        */
        ...
        m_scene->Load("scenes/spritescene.json");
        m_scene->Initialize();
        for(int i = 0; i < 10; i++)
        {
    ...
    void World0575::Shutdown()
    {
    }

    void World0575::Update(float dt)
    {
    ...
    void World0575::Draw(Renderer& renderer)
    {
        // pre-render
        renderer.BeginFrame();
